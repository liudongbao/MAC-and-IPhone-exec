...
{
    NSLog(@"about read  data of type %@ ", typeName);
...
- (void)changeKeyPath:(NSString *)keyPath 
             ofObject:(id)obj 
              toValue:(id)newValue   // setValue:forKeyPath: will cause the key-value observing method // to be called, which takes care of the undo stuff
{
